...
public class ScriptTrigger extends AbstractTrigger
    ...
    @Schema(
        ...
        description = """
            Image used by the Script task to run the inline PowerShell script; defaults to 'ghcr.io/kestra-io/powershell:latest'.
            Provide an image that includes PowerShell.
            """
    )
    @Builder.Default
    ...
    @Schema(
        ...
        description = """
            Multi-line script executed on each poll, with the same semantics as the PowerShell Script task.
            """
    )
    @NotNull
