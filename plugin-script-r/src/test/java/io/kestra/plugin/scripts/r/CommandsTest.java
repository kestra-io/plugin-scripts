...
class CommandsTest {
    ...
    void task() throws Exception {
        ...
        ScriptOutput run = rCommands.run(runContext);
        ...
        receive.blockLast();
        assertThat(List.copyOf(logs).stream().filter(logEntry -> logEntry.getMessage() != null && logEntry.getMessage().contains("[1]")).count(), is(1L));
    }
}
