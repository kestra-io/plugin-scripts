...
public interface PythonBasedPlugin extends Plugin {
    ...
    @Schema(
        ...
        description = """
            List of pip-compatible package specifiers (e.g. `pandas==2.0.0`, `requests>=2.28`) \
    ...
    @Schema(
        ...
        description = """
            If no version is explicitly specified, the task will attempt to extract the version \
