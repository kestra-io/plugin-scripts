...
class ScriptTriggerEvaluateTest {
    private static final String IMAGE = "mcr.microsoft.com/dotnet/sdk:10.0";
    ...
    void scriptTrigger_shouldEmitWhenExitCodeMatches() throws Exception {
        ScriptTrigger trigger = trigger("script-exit1", "System.Environment.Exit(1);");
    ...
    void scriptTrigger_shouldStayQuietWhenConditionDoesNotMatch() throws Exception {
        ScriptTrigger trigger = trigger("script-exit0", "System.Console.WriteLine(\"ok\");");
    ...
    void scriptTrigger_edgeModeShouldSuppressSecondEmissionAcrossFreshInstances() throws Exception {
        ScriptTrigger trigger = trigger("script-edge", "System.Environment.Exit(1);");
