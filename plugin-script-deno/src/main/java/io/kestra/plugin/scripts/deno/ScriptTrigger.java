...
public class ScriptTrigger extends AbstractTrigger
    ...
    @Schema(
        ...
        description = """
            Image used by the Script task to run the inline Deno script; defaults to 'denoland/deno'.
            Provide an image that includes the Deno runtime.
            """
    )
    @Builder.Default
    ...
    @Schema(
        ...
        description = """
            Multi-line script executed on each poll, with the same semantics as the Deno Script task.
            """
    )
    @NotNull
